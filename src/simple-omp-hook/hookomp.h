...
bool (*lib_GOMP_loop_nonmonotonic_dynamic_start)(long start, long end, long incr,
												 long chunk_size, long *istart,
												 long *iend);

bool (*lib_GOMP_loop_nonmonotonic_guided_start)(long start, long end, long incr,
...
bool (*lib_GOMP_loop_doacross_static_start)(unsigned ncounts, long *counts,
											long chunk_size, long *istart, long *iend);
bool (*lib_GOMP_loop_doacross_dynamic_start)(unsigned ncounts, long *counts,
											 long chunk_size, long *istart, long *iend);
bool (*lib_GOMP_loop_doacross_guided_start)(unsigned ncounts, long *counts,
											long chunk_size, long *istart, long *iend);

bool (*lib_GOMP_loop_doacross_runtime_start)(unsigned ncounts, long *counts,
											 long *istart, long *iend);
...
void (*lib_GOMP_parallel_loop_nonmonotonic_dynamic)(void (*fn)(void *), void *data,
													unsigned num_threads, long start,
													long end, long incr, long chunk_size,
													unsigned flags);

void (*lib_GOMP_parallel_loop_nonmonotonic_guided)(void (*fn)(void *), void *data,
												   unsigned num_threads, long start,
												   long end, long incr, long chunk_size,
												   unsigned flags);
...
bool (*lib_GOMP_loop_ull_nonmonotonic_dynamic_start)(bool up, gomp_ull start,
													 gomp_ull end, gomp_ull incr,
													 gomp_ull chunk_size,
													 gomp_ull *istart, gomp_ull *iend);
bool (*lib_GOMP_loop_ull_nonmonotonic_guided_start)(bool up, gomp_ull start, gomp_ull end,
...
static bool (*lib_gomp_loop_ull_doacross_static_start)(unsigned ncounts, gomp_ull *counts,
													   gomp_ull chunk_size, gomp_ull *istart,
													   gomp_ull *iend);
static bool (*lib_gomp_loop_ull_doacross_dynamic_start)(unsigned ncounts, gomp_ull *counts,
														gomp_ull chunk_size, gomp_ull *istart,
														gomp_ull *iend);
static bool (*lib_gomp_loop_ull_doacross_guided_start)(unsigned ncounts, gomp_ull *counts,
													   gomp_ull chunk_size, gomp_ull *istart,
													   gomp_ull *iend);
bool (*lib_GOMP_loop_ull_doacross_runtime_start)(unsigned ncounts, gomp_ull *counts,
												 gomp_ull *istart, gomp_ull *iend);
...
void (*lib_GOMP_taskloop)(void (*fn)(void *), void *data, void (*cpyfn)(void *, void *),
						  long arg_size, long arg_align, unsigned flags,
						  unsigned long num_tasks, int priority,
						  TYPE start, TYPE end, TYPE step);
void (*lib_GOMP_taskloop_ull)(void (*fn)(void *), void *data, void (*cpyfn)(void *, void *),
							  long arg_size, long arg_align, unsigned flags,
							  unsigned long num_tasks, int priority,
							  TYPE start, TYPE end, TYPE step);
...
/* oacc-parallel.c */
void (*lib_GOACC_parallel_keyed)(int device, void (*fn)(void *),
								 size_t mapnum, void **hostaddrs, size_t *sizes,
...
void (*lib_GOACC_declare)(int device, size_t mapnum,
						  void **hostaddrs, size_t *sizes, unsigned short *kinds);
...
extern "C"
{
	...
	bool GOMP_loop_nonmonotonic_dynamic_next(long *, long *);
	bool GOMP_loop_nonmonotonic_guided_next(long *, long *);
	...
	bool GOMP_loop_doacross_static_start(unsigned ncounts, long *counts,
										 long chunk_size, long *istart, long *iend);
	bool GOMP_loop_doacross_dynamic_start(unsigned ncounts, long *counts,
										  long chunk_size, long *istart, long *iend);
	bool GOMP_loop_doacross_guided_start(unsigned ncounts, long *counts,
										 long chunk_size, long *istart, long *iend);

	bool GOMP_loop_doacross_runtime_start(unsigned ncounts, long *counts,
										  long *istart, long *iend);
	...
	bool GOMP_loop_ull_doacross_static_start(unsigned ncounts, gomp_ull *counts,
											 gomp_ull chunk_size, gomp_ull *istart,
											 gomp_ull *iend);
	bool GOMP_loop_ull_doacross_dynamic_start(unsigned ncounts, gomp_ull *counts,
											  gomp_ull chunk_size, gomp_ull *istart,
											  gomp_ull *iend);
	bool GOMP_loop_ull_doacross_guided_start(unsigned ncounts, gomp_ull *counts,
											 gomp_ull chunk_size, gomp_ull *istart,
											 gomp_ull *iend);
	bool GOMP_loop_ull_doacross_runtime_start(unsigned ncounts, gomp_ull *counts,
											  gomp_ull *istart, gomp_ull *iend);
	...
	void GOMP_doacross_post(long *);
	void GOMP_doacross_wait(long, ...);
	void GOMP_doacross_ull_post(unsigned long long *);
	void GOMP_doacross_ull_wait(unsigned long long, ...);
	...
	GOMP_taskloop(void (*fn)(void *), void *data, void (*cpyfn)(void *, void *),
				  ...
				  TYPE start, TYPE end, TYPE step);
	void
	GOMP_taskloop_ull(void (*fn)(void *), void *data, void (*cpyfn)(void *, void *),
					  long arg_size, long arg_align, unsigned flags,
					  unsigned long num_tasks, int priority,
					  TYPE start, TYPE end, TYPE step);
	...
	void GOMP_target_ext(int, void (*)(void *), size_t, void **, size_t *,
						 unsigned short *, unsigned int, void **, void **);

	void GOMP_target_data(int device, const void *unused, size_t mapnum,
						  void **hostaddrs, size_t *sizes, unsigned char *kinds);

	void GOMP_target_data_ext(int, size_t, void **, size_t *,
							  unsigned short *);
	...
	void GOMP_target_update_ext(int, size_t, void **, size_t *,
								unsigned short *, unsigned int, void **);

	void GOMP_target_enter_exit_data(int, size_t, void **, size_t *,
	...
	/* oacc-parallel.c */
	void GOACC_parallel_keyed(int device, void (*fn)(void *),
							  size_t mapnum, void **hostaddrs, size_t *sizes,
							  unsigned short *kinds, ...);
	...
	void GOACC_declare(int device, size_t mapnum,
					   void **hostaddrs, size_t *sizes, unsigned short *kinds);
